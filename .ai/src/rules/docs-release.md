...
- `7.0.0-dev8` to `7.0.0-dev11` shipped in the glued form and Pub ranks `7.0.0-dev9` highest, which is why 7.0.0 moved to the `rc` label (`7.0.0-rc.N`); escape a glued series already on pub.dev by changing the label, never by renumbering.
