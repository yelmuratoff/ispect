...
Color adjustColorBrightness(Color color, double brightness) {
  ...
  final int red = ((color.red * brightness) + (255 * (1.0 - brightness))).round();
  final int green = ((color.green * brightness) + (255 * (1.0 - brightness))).round();
  final int blue = ((color.blue * brightness) + (255 * (1.0 - brightness))).round();
