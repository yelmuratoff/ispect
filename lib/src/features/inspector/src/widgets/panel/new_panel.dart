...
// Default positions for the panel;
                      ...
                      Flexible(
                        child: GestureDetector(
                          onPanEnd: (event) {
                            ...
                            widget.onPositionChanged?.call(_draggablePositionLeft.value, _draggablePositionTop.value);
                          },
                          onPanStart: (event) {
                          ...
                          onPanUpdate: (event) {
                            ...
                            if (_draggablePositionTop.value > (pageHeight - _panelHeight) - _dockBoundary) {
                              _draggablePositionTop.value = (pageHeight - _panelHeight) - _dockBoundary;
                            }
  ...
  void _toggleButton(double pageWidth, double pageHeight) {
    if (_panelState.value == PanelState.open) {
      ...
      _draggablePositionLeft.value = _openDockLeft(pageWidth);
  ...
  void _calcPanelTop(double pageHeight) {
    if (_draggablePositionTop.value + _panelHeight > pageHeight + _dockBoundary) {
      _draggablePositionTop.value = pageHeight - _panelHeight + _dockBoundary;
    }
  }
