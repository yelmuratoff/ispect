...
///
/// `ispectify_ws` is provider-agnostic and no longer ships a `ws`-bound
/// interceptor; apps copy this thin adapter and depend on `ws` themselves.
/// See `packages/ispectify_ws/example/lib/interceptors/ws_interceptor.dart`.
