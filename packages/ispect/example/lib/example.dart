        ...
        builder: (context, localeProvider, child) {
          return MaterialApp(
            ...
            localizationsDelegates: [
              ...
              InspectorGeneratedLocalizationZhDelegate()
            ],
...
class InspectorGeneratedLocalizationZhDelegate
    extends LocalizationsDelegate<ISpectGeneratedLocalization> {
  const InspectorGeneratedLocalizationZhDelegate();
  ...
  @override
  Future<ISpectGeneratedLocalization> load(Locale locale) async {
  ...
  @override
  bool shouldReload(LocalizationsDelegate<ISpectGeneratedLocalization> old) {
    return false;
  }
}

class ISpectGeneratedLocalizationZh extends ISpectGeneratedLocalization {
  ISpectGeneratedLocalizationZh([super.locale = 'zh']);
