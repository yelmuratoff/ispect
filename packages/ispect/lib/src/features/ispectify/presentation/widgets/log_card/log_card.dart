...
import 'package:ispect/src/features/ispectify/presentation/pages/http/detailed_http_page.dart';
...
class _ISpectifyDataCardState extends State<ISpectLogCard> {
  ...
  String? get _getMessage {
    ...
    final isHttpLog = [
      HttpRequestLog.getKey,
      HttpResponseLog.getKey,
      HttpErrorLog.getKey,
    ].contains(widget.data.key);
    if (isHttpLog) {
      return widget.data.textMessage;
    }
    return widget.data.messageText;
  }
