...
class ExpansionTileController {
  ...
  _ISpectExpansionTileState? _state;
  ...
  static ExpansionTileController of(BuildContext context) {
    final result = context.findAncestorStateOfType<_ISpectExpansionTileState>();
    if (result != null) {
  ...
  ///    documentation.
  static ExpansionTileController? maybeOf(BuildContext context) => context
      .findAncestorStateOfType<_ISpectExpansionTileState>()
      ?._tileController;
}
...
class ISpectExpansionTile extends StatefulWidget {
  /// Creates a single-line `ListTile` with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the `children`. The [initiallyExpanded] property must
  /// be non-null.
  const ISpectExpansionTile({
    required this.title,
    super.key,
    this.leading,
    this.subtitle,
...
class _ISpectExpansionTileState extends State<ISpectExpansionTile>
  ...
  final Tween<double> _heightFactorTween = Tween<double>(begin: 0, end: 1);
  ...
  ListTileControlAffinity _effectiveAffinity() {
    ...
    final affinity = widget.controlAffinity ??
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final expansionTileTheme = ExpansionTileTheme.of(
      context,
    );
    final backgroundColor = _backgroundColor.value ??
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              if (widget.dividerColor != null && _isExpanded)
                Divider(
    ...
    final isShapeProvided = widget.shape != null ||
  ...
  @override
  void didUpdateWidget(covariant ISpectExpansionTile oldWidget) {
