        ...
        child: Container(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              //                       ),
              //                       TextSpan(
              //                         text: ' ${context.ispectL10n.iSpectifyTypeHttp}.',
              //                         style: TextStyle(
              //                           color: iSpect.theme.getTypeColor(
              //                             context,
              //                             key: 'http-request',
...
class _InfoDescriptionPlaceholder extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          ...
          const Gap(16),
          Text(
            context.ispectL10n.iSpectifyTypeHttp,
            style: TextStyle(
              color: context.ispectTheme.textColor,
              fontSize: 16,
              fontWeight: FontWeight.w500,
          ...
          const Gap(16),
          Text(
            context.ispectL10n.iSpectifyTypeBloc,
            style: TextStyle(
              color: context.ispectTheme.textColor,
              fontSize: 16,
              fontWeight: FontWeight.w500,
          ...
          const Gap(16),
          Text(
            context.ispectL10n.iSpectifyTypeRiverpod,
            style: TextStyle(
              color: context.ispectTheme.textColor,
              fontSize: 16,
              fontWeight: FontWeight.w500,
