...
```yaml
dependencies:
  ispect: ^5.0.0-dev10 # Core UI, inspector, log viewer
  ispectify: ^5.0.0-dev10 # Logging backbone (Dart-only, no Flutter)
  ispectify_dio: ^5.0.0-dev10 # Dio HTTP interceptor
  ispectify_http: ^5.0.0-dev10 # http package interceptor
  ispectify_ws: ^5.0.0-dev10 # WebSocket traffic capture
  ispectify_db: ^5.0.0-dev10 # Database operation tracking
  ispectify_bloc: ^5.0.0-dev10 # BLoC event/state observer
```
