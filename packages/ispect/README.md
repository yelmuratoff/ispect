...
dependencies:
  ...
  ispectify_dio: ^4.4.3-dev01      # For Dio HTTP client
  ispectify_http: ^4.4.3-dev01     # For standard HTTP package
  
  # Database integration
  ispectify_db: ^4.4.3-dev01       # For database operation logging
  
  # WebSocket integration
  ispectify_ws: ^4.4.3-dev01       # For WebSocket monitoring
  
  # State management integration
  ispectify_bloc: ^4.4.3-dev01     # For BLoC state management
  
  # Optional: Jira integration
  ispect_jira: ^4.4.3-dev01        # For automated bug reporting
```
