...
String formatInspectorDouble(double value, {int decimalPlaces = 1}) {
  assert(decimalPlaces >= 0, 'decimalPlaces must be >= 0');
  return value.toStringAsFixed(decimalPlaces);
}

String formatInspectorSize(Size size, {int decimalPlaces = 1}) =>
...
String formatInspectorOffset(Offset offset, {int decimalPlaces = 1}) =>
