...
void main() {
  testWidgets('one pointer sample emits one consolidated inspect state', (
    tester,
  ) async {
    ...
    controller.hoveredRenderBoxNotifier.addListener(() => hoveredEmissions++);
    controller.comparedRenderBoxNotifier.addListener(() => comparedEmissions++);
