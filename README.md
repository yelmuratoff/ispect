...
dependencies:
  ...
  ispectify_dio: ^4.4.3-dev02      # For Dio HTTP client
  ispectify_http: ^4.4.3-dev02     # For standard HTTP package
  
  # Database integration
  ispectify_db: ^4.4.3-dev02       # For database operation logging
  
  # WebSocket integration
  ispectify_ws: ^4.4.3-dev02       # For WebSocket monitoring
  
  # State management integration
  ispectify_bloc: ^4.4.3-dev02     # For BLoC state management
