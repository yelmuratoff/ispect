...
dependencies:
  ...
  ispectify_dio: ^4.4.0-dev08      # For Dio HTTP client
  ispectify_http: ^4.4.0-dev08     # For standard HTTP package
  
  # Database integration
  ispectify_db: ^4.4.0-dev08       # For database operation logging
  
  # WebSocket integration
  ispectify_ws: ^4.4.0-dev08       # For WebSocket monitoring
  
  # State management integration
  ispectify_bloc: ^4.4.0-dev08     # For BLoC state management
  
  # Optional: Jira integration
  ispect_jira: ^4.4.0-dev08        # For automated bug reporting
```
